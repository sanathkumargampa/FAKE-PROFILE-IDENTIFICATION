...
--
-- Database: `fake_profile_identification`
--
CREATE DATABASE IF NOT EXISTS `fake_profile_identification` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `fake_profile_identification`;
...
CREATE TABLE IF NOT EXISTS `remote_user_profile_identification_type` (
`id` int(11) NOT NULL AUTO_INCREMENT,
prof_idno varchar(3000) NOT NULL,
name varchar(3000) NOT NULL,
screen_name varchar(3000) NOT NULL,
statuses_count varchar(3000) NOT NULL,
followers_count varchar(3000) NOT NULL,
friends_count varchar(3000) NOT NULL,
created_at varchar(3000) NOT NULL,
location varchar(3000) NOT NULL,
default_profile varchar(3000) NOT NULL,
prf_image_url varchar(3000) NOT NULL,
prf_banner_url varchar(3000) NOT NULL,
prf_bgimg_https varchar(3000) NOT NULL,
prf_text_color varchar(3000) NOT NULL,
profile_image_url_https varchar(3000) NOT NULL,
prf_bg_title varchar(3000) NOT NULL,
profile_background_image_url varchar(3000) NOT NULL,
description varchar(3000) NOT NULL,
Prf_updated varchar(3000) NOT NULL,
